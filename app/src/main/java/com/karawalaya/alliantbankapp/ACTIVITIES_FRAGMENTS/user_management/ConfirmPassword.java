...
public class ConfirmPassword extends AppCompatActivity {
    ...
    private UMValidator inputValidation;
    private UserManagementDAO databaseHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inputValidation = new UMValidator(this);
        databaseHelper = new UserManagementDAO(this);
    ...
    private void updatePassword() {
        ...
        if (!databaseHelper.checkUser(email)) {
            ...
            Snackbar.make(nestedScrollView, "username doesn't exist", Snackbar.LENGTH_LONG).show();
            return;
